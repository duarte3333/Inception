...
// define( 'DB_NAME', 'inception'); etc: These lines 
// set up the connection to the database where WordPress stores 
// all its data. You need to replace 'inception', 'wordpress', 
// 'pass', and '' with your actual database name, user, password, and host.
